...
app.post('/login', async (req, res) => {
  try {
    ...
    console.log('reCAPTCHA response:', recJson);
    if (!recJson.success) {
...
// Servir tu HTML principal (peces.html)
app.get('/', (req, res) => {
  res.sendFile(path.join(__dirname, 'public', 'peces.html'));
});

// Opcional: catch-all para rutas de páginas de detalle
app.get('/peces/:slug', (req, res) => {
  res.sendFile(path.join(__dirname, 'public', 'peces.html'));
});
